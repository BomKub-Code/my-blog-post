// ข้อมูล mock ชุดนี้ยังไม่ได้ถูก import ไปใช้ที่ไหนในโปรเจกต์ (หน้าจริงดึงข้อมูลจาก
// api.js/`/posts` แทน) เก็บไว้เผื่อใช้อ้างอิง โครงสร้างข้อมูล หรือ seed ข้อมูลทดสอบในอนาคต
